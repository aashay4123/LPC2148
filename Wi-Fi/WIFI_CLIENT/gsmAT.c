	...
	//#####################################################
	  ...
	  soft_delay_ms(500);
  	 ...
  	 soft_delay_ms(1000);
		 ...
		 soft_delay_ms(1000);
		 send_string("AT+CWJAP=\"Windows Phone\",\"1234567890\"");    //AT command to join network
		 soft_delay_ms(10);
		 send_char(0x0d);
		 soft_delay_ms(10);
		 send_char(0x0a);
     ...
     LCD_Cmd(0x01);
		 ...
		 soft_delay_ms(10);
		 send_string("AT+CIPSTART=1,\"TCP\",\"192.168.137.166\",1336");    //AT command to start a TCP connection
		 soft_delay_ms(10);
		 send_char(0x0d);
		 soft_delay_ms(10);
		 send_char(0x0a);
